...
PROMPT = """
Task: Identify and verify factual claims from the given text. Use credible web sources to check the accuracy of each claim. Present your findings in a structured JSON format with each claim, the verification source, and the outcome of the verification.
Output Format: 
...
def main():
    ...
    new_claims = json.loads(claims['content'])
